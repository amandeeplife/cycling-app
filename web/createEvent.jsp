...
<div id="right-panel">
    <div>
        ...
        <button class="btn btn-primary" style="float: right" onclick="window.location.href='/welcome-dashboard.jsp'">Go
            to Dashboard
        </button>
        ...
        <form id="eventCreate" method="post" action="EventController">
            ...
            Event!<br><br>
            Event Title :<span id="msg"></span> <input id="title" name="eventTitle" type="text"
