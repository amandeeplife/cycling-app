...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Dashboard</h1> <button class="btn btn-success" style="float: right" data-toggle="modal" data-target="#myModal">
                Create Event
            </button>
                <!-- Modal -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form >
                                ...
                                Please Fill the following information if you would like to create an Event!<br><br>
                ...
                <div class="panel panel-primary">
                    ...
                    <a href="#">
                        <div class="panel-footer">
                            <button type="button" class="btn btn-primary">Modify</button> <button type="button" class="btn btn-info">View</button>  <button type="button" class="btn btn-danger">Delete</button>
