...
<html>
  <head>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css">    <title>$Title$</title>
  <link rel="stylesheet" href="Res/loginPage/style.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script src="Res/loginPage/indexPage.js"></script>
  </head>
  <body>
  <nav class="main-nav">
    <ul>
  ...
  <div class="user-modal">
    <div class="user-modal-container">
      ...
      <div id="login">
        <form class="form" action="welcome-dashboard.jsp">
          <p class="fieldset">
