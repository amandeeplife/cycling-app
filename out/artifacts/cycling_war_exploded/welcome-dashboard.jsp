                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    ...
                                    <button style="margin: 0 2px" class="btn btn-primary" style="float: right"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div style="margin: auto; width: 70%">
                                                            Please Fill the following information if you would like to
                                                            create an
                                                            Event!<br><br>
                                                            ...
                                                            Discription : <textarea class="form-control"
                                                                                    rows="3"></textarea><br>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input id="saveEvent" type="submit" value="Save Changes"
                                    ...
                                    <button style="margin: 0 2px" class="btn btn-info" style="float: right"
                                    ...
                                    <button style="margin: 0 2px" class="btn btn-danger" style="float: right"
